...
export function FileUpload({ onFileUploaded, onFileRemoved, uploadedFiles, disabled }: FileUploadProps) {
  ...
  const handleFileUpload = async (files: FileList) => {
    for (const file of Array.from(files)) {
      ...
      trackEvent('fileUploadStarted', { type: file.type, size: file.size })
      ...
      try {
        ...
        trackEvent('fileUploadCompleted', { type: file.type, size: file.size })
      } catch (error) {
        ...
        trackEvent('fileUploadFailed', { type: file.type, size: file.size })
      }
    }
  }
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() => {
                      trackEvent('fileRemoved', { type: file.type })
